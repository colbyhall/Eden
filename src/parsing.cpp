...
BS(    DFA_PREPROC,               // WHITE: DFA_PREPROC_BS
...
BS(    DFA_PREPROC,               // NEWLINE: DFA_PREPROC_BS
...
BS(    DFA_PREPROC,               // IDENT: DFA_PREPROC_BS
...
BS(    DFA_PREPROC,               // POUND: DFA_PREPROC_BS
...
BS(    DFA_PREPROC,       // DOUBLEQUOTE: DFA_PREPROC_BS
...
BS(    DFA_PREPROC,               // SINGLEQUOTE: DFA_PREPROC_BS
...
BS(    DFA_PREPROC,               // DIGIT: DFA_PREPROC_BS
...
BS(    ADD | DFA_PREPROC_SLASH,   // SLASH: DFA_PREPROC_BS
...
BS(    DFA_PREPROC,                     // STAR: DFA_PREPROC_BS
...
BS(DFA_PREPROC_BS) BN(DFA_PREPROC),                  // BS: DFA_PREPROC
BS(    DFA_PREPROC_BS,                  // BS: DFA_PREPROC_BS
...
BS(    DFA_PREPROC,                     // OP: DFA_PREPROC_BS
)  };
